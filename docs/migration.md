...
* [Migrating from v4 to v5](#migrating-from-v4-to-v5)
  * [Dropped Node.js v20 and v22.11 support](#dropped-nodejs-v20-support)
...
The library now exports native ESM modules so the exports may have changed. Using Node.js v22.12 and above will allow you to import via `require`.
